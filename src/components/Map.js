        ...
        <div>
          ...
          <ul id="navbar-menu">
            ...
            <div className="bottom-section">
              ...
              <button id="submit" onClick={() => getMessages(1)}>Latest info</button>
              </div>
              <div className="input-container">
              <button id="prepare" onClick={() => getMessages(2)}>How can I prepare?</button>
              </div>
              <div className="input-container">
              <button id="respond" onClick={() => getMessages(3)}>How can I respond?</button>
              </div>
              <div className="input-container">
              <button id="recover" onClick={() => getMessages(4)}>How can I help recover?</button>
              </div>
            </div>
          </section>
        </div>
